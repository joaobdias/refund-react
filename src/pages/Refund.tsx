...
export function Refund() {
  ...
  return (
    ...
    >
      ...
      {params.id && fileURL ? (
        <a
          href={`http://localhost:3333/uploads/${setFileURL}`}
          target="_blank"
          className="text-sm text-green-100 font-semibold flex items-center justify-center gap-2 my-6 hover:opacity-75 transition ease-linear"
        >
